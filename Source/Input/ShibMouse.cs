...
namespace CodenamedEngine
{
    public class ShibMouse
    {
        ...
        {
            if( newMouse.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && oldMouse.LeftButton != Microsoft.Xna.Framework.Input.ButtonState.Pressed && newMouse.Position.X >= 0 && newMouse.Position.X <= Helper.screenWidth && newMouse.Position.Y >= 0 && newMouse.Position.Y <= Helper.screenHeight)
            {
                return true;
            }
        ...
        {
            if(newMouse.RightButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && oldMouse.RightButton != Microsoft.Xna.Framework.Input.ButtonState.Pressed && newMouse.Position.X >= 0 && newMouse.Position.X <= Helper.screenWidth && newMouse.Position.Y >= 0 && newMouse.Position.Y <= Helper.screenHeight)
            {
                return true;
            }
